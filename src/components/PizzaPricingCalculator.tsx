    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="bg-white p-8 rounded-[40px] border border-slate-200 shadow-sm">
        ...
        <div className="flex justify-end mb-8">
          <button onClick={handleAddIngredient} className="bg-slate-900 text-white px-6 py-3 rounded-xl font-black uppercase text-xs tracking-widest hover:bg-black transition-all">
              ...
              <div className="flex gap-2">
                ...
                <button 
                  onClick={() => {
                    ...
                    if (sel.value) handleAddIngredientToRecipe(sel.value);
                  }}
                    ...
                    <div key={ri.ingredientId} className="flex flex-col sm:flex-row gap-3 items-center justify-between bg-white p-3 rounded-xl border border-slate-100 shadow-sm">
                      ...
                      <div className="flex items-center gap-2">
                        <input 
                          ...
                          className="w-20 bg-slate-50 border border-slate-200 rounded-lg px-2 py-1 text-xs font-bold text-center"
                          placeholder="Qtd"
                        />
           ...
           <div className="mt-12">
             ...
             <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
               {recipes.map(recipe => {
                 ...
                 return (
                   <div key={recipe.id} className="bg-slate-50 border border-slate-200 p-6 rounded-3xl relative group">
                     <button onClick={() => handleRemoveRecipe(recipe.id)} className="absolute top-4 right-4 text-slate-300 hover:text-red-500 opacity-0 group-hover:opacity-100 transition-all">✖</button>
                     <h5 className="font-black text-slate-800 text-lg mb-4 pr-6">{recipe.name}</h5>
